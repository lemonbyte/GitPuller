<?php #!/usr/bin/env /usr/bin/php
	...
	// Server ip checken / als in local modus dan local host, anders naar live omgeiveing maken.
	$ip = $_SERVER["SERVER_ADDR"];
	
	// Probeer de payload te laden.
	try {
		...
		$exec = new Git_Puller_Class();
		$exec->execute($payload);
		
	}
	// Als de payload niet kan worden geladen
	catch(Exception $e) {
