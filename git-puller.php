<?php #!/usr/bin/env /usr/bin/php
	...
	try {
		...
		//var_dump($payload->commits[0]->timestamp);
 	 	//var_dump($payload->repository->name);
 	 		 
 	 	//die();
	 	
	 	
	 	// Commiter ( Naam, Email, Usernaam )
		//echo "Email".$payload->commits[0]->committer->email;
	 	//echo "<br />"."Name". $payload->commits[0]->committer->name;
	 	//echo "<br />"."Gebruikersnaam". $payload->commits[0]->committer->username;
	 	
	 	// Comit massage
	 	//echo "<br />"."Bericht". $payload->commits[0]->message;
	 	
	 	// Bestanden die zijn aangepast.
	 	//echo "<br />"."Aangepast". $payload->commits[0]->modified[0];
	 	//echo "<br />"."Verwijderd". isset($payload->commits[0]->removed[0]);
	 	//echo "<br />"."Timestamp". $payload->commits[0]->timestamp;
	 	//die();	 
